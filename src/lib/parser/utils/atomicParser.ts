...
import { updateParserError, updateParserState, updateSupressedParserError } from './utilsParser';

const str: ParserMaker = (target: string, identifier?: string) => (parserState: ParserState, supressErrors?: boolean) => {
